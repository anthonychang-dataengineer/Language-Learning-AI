            ...
            messages: [
                {
                    ...
                    And any other words in the sentence must come from this list, no where else:
                    \n=== ${knownWords.join("\n")} \n
...
const attempt_grading_JSON_output = await anthropic.messages.create({
            ...
            messages: [
                {
                    ...
                    Update the score for each word in the word list I provided and return it.
        ...
        function updateMastery(word, claudeWordGrades) {
          const rate = claudeWordGrades > word.mastery ? REWARD_RATE : PENALTY_RATE
          word.mastery += (claudeWordGrades - word.mastery) * rate
        }
...
//think about updating the logic more
