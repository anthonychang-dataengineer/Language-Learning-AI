  ...
  try {
    ...
    const lesson_sentence_JSON_output = await anthropic.messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `You are a Christian missionary trying to recruit people to become Christian. You are new to the city.
          Generate a natural Mandarin sentence as if you're this character. 
          The sentence should reflect your character but can be about ANY topic. You do NOT have to use church-related words
          The sentence should follow these rules"
          HARD RULE - This is non-negotiable:
          You MUST use ONLY words from the "REQUIRED WORDS" and "ALLOWED WORDS". Do NOT use any other words, even if they would make the sentence better or more natural. 
          Do NOT ANY words not in the list below.
          REQUIRED WORDS (must include): ${numWordPrompt} \n
          ALLOWED WORDS (use ONLY these for the rest of the sentence): Any other words in the sentence MUST come from this input list, no where else:
